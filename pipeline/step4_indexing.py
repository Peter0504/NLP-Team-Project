...
# Point to the processed data folder
BASE_DIR = Path(".")
PROC_DIR = BASE_DIR / "data" / "processed"

# 1. Load OpenAI Embeddings & FAISS Vector Store
embeddings = OpenAIEmbeddings(model="text-embedding-3-small")
vectorstore = FAISS.load_local(str(PROC_DIR / "faiss_index"), embeddings, allow_dangerous_deserialization=True)
...
# 3. Create Custom Hybrid Retriever (Bypasses the missing LangChain module)
